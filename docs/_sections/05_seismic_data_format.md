...
In addition to the changes mentioned above, for convenience, $\mu$Quake library offers mechanism to store `Ray` and `Proba
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDcwNDgzODUsMTA5NjYzOTk2MV19
-->