...
Our proposed schema exploits the adaptable seismic data format (ASDF), which is based on well-established file formats widely adopted in seismology:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MjcxODkzNjgsMTg0Nzg2MzM0NCwtMj
